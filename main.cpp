...
public:
	...
	FUNCION GENERICA AGREGADA PARA PODER ABRIR LAS MALLAS PORQUE SE REPETIA DEMASIADO
	...
	*/
	...
	FUNCION GENERICA PARA ABRIR EL SHADER DE LOS OBJETOS TEXTURIZADOS TENIENDO EN CUENTA QUE SE PUEDE CAMBIAR LA ESCALA
	...
	*/
	...
	void openShaderTexScaled(float xt, float yt, float zt, float xs, float ys, float zs, GLuint t, GLMmodel **ptr)
	{
		...
		glScalef(xs, ys, zs); // reducira toda la imagen a un % con respecto a la original la escala de este objeto "esta demasiado grande". (el tama�o actual se toma como si fuera 100% = 1.0 y por ejemplo si le ponemos 10% sera un 0.1 de ese tama�o original)
	...
	TIENE LA MISMA FUNCIONALIDAD DEL ANTERIOR PERO ESTE ES PARA OBJETOS NO TEXTURIZADOS
	...
	*/
	...
	virtual void OnRender(void)
	{
		...
		glScalef(0.08f, 0.08f, 0.08f);			// reducira toda la imagen a un 1% con respecto a la original la escala de este objeto "esta demasiado grande". (el tama�o actual se toma como si fuera 100% y por ejemplo si le ponemos 10% sera un 10% de ese tama�o original)
		...
		glScalef(0.25f, 0.25f, 0.25f);			// reducira toda la imagen a un 1% con respecto a la original la escala de este objeto "esta demasiado grande". (el tama�o actual se toma como si fuera 100% y por ejemplo si le ponemos 10% sera un 10% de ese tama�o original)
		...
		glScalef(0.1f, 0.1f, 0.1f);			// reducira toda la imagen a un 1% con respecto a la original la escala de este objeto "esta demasiado grande". (el tama�o actual se toma como si fuera 100% y por ejemplo si le ponemos 10% sera un 10% de ese tama�o original)
		...
		glScalef(0.12f, 0.12f, 0.12f);			// reducira toda la imagen a un 1% con respecto a la original la escala de este objeto "esta demasiado grande". (el tama�o actual se toma como si fuera 100% y por ejemplo si le ponemos 10% sera un 10% de ese tama�o original)
		...
		glScalef(0.10f, 0.10f, 0.125f);			// reducira toda la imagen a un 1% con respecto a la original la escala de este objeto "esta demasiado grande". (el tama�o actual se toma como si fuera 100% y por ejemplo si le ponemos 10% sera un 10% de ese tama�o original)
	...
	virtual void OnInit()
	{
		...
		// Abrir mallas con implementacion nueva con funciones
